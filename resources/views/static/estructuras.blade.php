            ...
            <div class="col-lg-9 order-1 order-lg-2 data_col" id="subsistemas_col" style="background: #ffffff;border-top-right-radius: 10px;">
                ...
                <div class="row page_row" id="article_results_container_row">
                    <div class="col-12 article_col">
                        <h2 id="heading_static_page">Estructuras Organizacionales</h2>
                    </div>
                    <div class="col-12 d-flex justify-content-center align-items-center article_col"><img class="img-fluid" src="{{ asset('img/organigrama.png')}}"></div>
                </div>
            </div>
        </div>
    </div>
