                ...
                <div class="row page_row" id="article_results_container_row">
                    <div class="col-12 article_col">
                        ...
                        <ul>
                            ...
                            <li>Contribuir al intercambio de experiencias y la generación de conocimientos que permita desarrollar competencias profesionales entre la comunidad editora.<br></li>
                            <li>Desarrollar capacidades que permitan tener un mayor uso y aprovechamiento de las tecnologías de información y comunicación en la actividad editorial.<br></li>
                        ...
                        <p>Los talleres estarán dirigidos a editores, equipos editoriales y todos aquellos profesionales interesados en adquirir conocimientos que les permitan participar eficientemente en los procesos editoriales digitales de edición, publicación y distribución de libros y revistas académicas.<br></p>
                        <h4>Oferta académica:<br></h4>
                        <h5>A. Revistas académicas<br></h5>
                        <ol>
                            <li><strong>Uso de la plataforma de gestión editorial Open Journal Systems (OJS)</strong><br><strong>Duración: 20 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                            ...
                            <li><strong>Difusión y visibilidad de las revistas académicas</strong><br><strong>Duración: 20 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                        ...
                        <ol>
                            <li><strong>Uso de la plataforma de gestión editorial Open Monograph Press (OMP)</strong><br><strong>Duración: 20 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                                    <li>Instalación y configuración de la plataforma<br></li>
                            ...
                            <li><strong>Producción y edición de eBooks (1)</strong><br><strong>Duración: 20 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                            ...
                            <li><strong>Producción y edición de eBooks (2)</strong><br><strong>Duración: 20 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                            ...
                            <li><strong>Distribución de libros académicos</strong><br><strong>Duración: 10 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                        ...
                        <ol>
                            <li><strong>Formatos de publicación digital</strong><br><strong>Duración: 10 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                            ...
                            <li><strong>Derechos de autor</strong><br><strong>Duración: 10 hrs.</strong><br><strong>Temas:</strong>
                                <ol>
                        ...
                        <h5>Costos</h5>
                        <p><strong>Personal de la UNAM:</strong></p>
                        <ul>
                            <li>Sin costo</li>
                        </ul>
                        <p><strong>Alumnos de la UNAM y otras instituciones:</strong><br></p>
                        <ul>
                            <li>Talleres de 12 horas: $1,500.00.<br></li>
                            <li>Talleres de 16 y 20 horas: $2,000.00.<br></li>
                        </ul>
                        <p><strong>Personal de otras instituciones:</strong><br></p>
                        <ul>
                            <li>Talleres de 12 horas: $2,000.00.<br></li>
                            <li>Talleres de 16 y 20 horas: $2,500.00.<br></li>
                        </ul>
                        <h5>Informes<br></h5>
